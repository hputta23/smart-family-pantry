...
export default function SmartFamilyPantryApp() {
  return (
    <>
      ...
      <form className="space-y-stack-md">
        ...
        <div className="space-y-stack-sm">
          ...
          <div className="relative">
            <input className="w-full bg-white border-2 border-outline-variant focus:border-primary focus:ring-0 rounded-lg px-4 py-3 text-body-md transition-all outline-none" id="email" placeholder="e.g. mom@kitchen.com" required type="email" />
          </div>
        </div>
        {/* Password Field */}
        <div className="space-y-stack-sm">
          ...
          <div className="relative">
            <input className="w-full bg-white border-2 border-outline-variant focus:border-primary focus:ring-0 rounded-lg px-4 py-3 text-body-md transition-all outline-none" id="password" placeholder="••••••••" required type="password" />
          </div>
        </div>
        ...
        <div className="pt-2 space-y-3">
          <button className="w-full bg-primary text-on-primary font-label-bold text-body-md py-4 rounded-lg board-shadow hover:opacity-90 active:scale-[0.98] transition-all flex items-center justify-center gap-2" type="submit">
            <span>Log In</span>
            <span className="material-symbols-outlined text-lg" data-icon="login">login</span>
          </button>
          <button className="w-full bg-surface-container-high text-primary border border-primary font-label-bold text-body-md py-4 rounded-lg hover:bg-primary hover:text-on-primary transition-all active:scale-[0.98]" type="button">
